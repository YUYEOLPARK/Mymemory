...
// 마스터 뷰 컨트롤러가 담당하는 역할
// 페이지 뷰 컨트롤러 객체를 생성
// 데이터 소스가 될 콘텐츠 뷰 컨트롤러를 동적으로 생성하여 페이지 뷰 컨트롤러와 조합
import UIKit
...
class TutorialMasterVC: UIViewController, UIPageViewControllerDataSource {
    ...
    //콘텐츠 뷰 컨트롤러에 들어갈 타이틀과 이미지 (페이지 인덱스에 맞춰 콘텐츠 뷰 컨트롤러 타이틀과 이미지에 대입될 것들)
    ...
    func getContentVC(atIndex idx: Int) -> UIViewController? {
        ...
        //"ContentsVC"라는 Storyboard ID를 가진 뷰 컨트롤러의 인스턴스를 생성하고 캐스팅 한다.
    ...
    //현재 콘텐츠 뷰 컨트롤러보다 앞쪽에 올 콘텐츠 뷰 컨틀롤러 객체
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        return self.getContentVC(atIndex: index) //콘텐츠 뷰 동적 생성
    }
    
    // 현재의 콘텐츠 뷰 컨트롤러 보다 뒤쪽에 올 콘텐츠 뷰 컨트롤러 객체
